      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mb-2">
            <div className="p-2 sm:p-3 md:p-4 bg-gradient-to-br from-primary/20 to-primary/10 rounded-lg sm:rounded-xl md:rounded-2xl">
        ...
        <motion.div 
          ...
          className="bg-base-100 rounded-xl sm:rounded-2xl shadow-lg border border-base-300 p-4 sm:p-6 mb-6 sm:mb-8"
        >
          <div className="flex items-center gap-2 sm:gap-3 mb-4">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-base-content">Filter Lessons</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full p-2.5 sm:p-3 border-2 border-base-300 rounded-lg sm:rounded-xl focus:border-primary focus:outline-none transition-all duration-300 bg-base-50 text-base-content text-sm sm:text-base"
              >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full p-2.5 sm:p-3 border-2 border-base-300 rounded-lg sm:rounded-xl focus:border-secondary focus:outline-none transition-all duration-300 bg-base-50 text-base-content text-sm sm:text-base"
              >
            ...
            <div className="space-y-2 sm:col-span-2 lg:col-span-1">
              ...
              <select
                ...
                className="w-full p-2.5 sm:p-3 border-2 border-base-300 rounded-lg sm:rounded-xl focus:border-warning focus:outline-none transition-all duration-300 bg-base-50 text-base-content text-sm sm:text-base"
              >
        ...
        <motion.div 
          ...
          className="bg-base-100 rounded-xl sm:rounded-2xl shadow-2xl border border-base-300 overflow-hidden"
        >
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 p-4 sm:p-6 border-b border-base-300">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-base-content">Lessons Management</h3>
                <p className="text-base-content/70 text-xs sm:text-sm">Total: {lessons.length} lessons</p>
              </div>
            </div>
          </div>
          ...
          <div className="block md:hidden">
            {lessons.length > 0 ? lessons.map((lesson, index) => (
              <motion.div
                ...
                className="border-b border-base-300 p-4 hover:bg-base-200/50 transition-colors duration-200"
              >
                <div className="space-y-3">
                  {/* Title and ID */}
                  <div>
                    <h4 className="font-medium text-base-content text-sm">{lesson.title}</h4>
                    <p className="text-xs text-base-content/70">ID: {lesson._id?.slice(-8)}</p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    <motion.button
                      ...
                      className="px-3 py-1.5 text-xs font-medium rounded-lg bg-info/10 text-info border border-info/20 hover:bg-info/20 transition-all duration-200 min-h-[32px]"
                    >
                    ...
                    <motion.button
                      ...
                      className="px-3 py-1.5 text-xs font-medium rounded-lg bg-success/10 text-success border border-success/20 hover:bg-success/20 transition-all duration-200 min-h-[32px]"
                    >
                    ...
                    <motion.button
                      ...
                      className="px-3 py-1.5 text-xs font-medium rounded-lg bg-error/10 text-error border border-error/20 hover:bg-error/20 transition-all duration-200 min-h-[32px]"
                    >
                      Delete
                    </motion.button>
                  </div>
              ...
              <div className="p-8 text-center">
                ...
                <h3 className="text-lg font-semibold text-base-content mb-2">No Lessons Found</h3>
                <p className="text-sm text-base-content/70">Try adjusting your filters to see more results</p>
              </div>
            )}
          </div>
          ...
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full">
              <thead className="bg-base-200">
                <tr>
                  <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-sm font-semibold text-base-content">Title</th>
                  <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-sm font-semibold text-base-content hidden md:table-cell">Category</th>
                  <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-sm font-semibold text-base-content">Visibility</th>
                  <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-sm font-semibold text-base-content hidden lg:table-cell">Creator</th>
                  <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-sm font-semibold text-base-content">Status</th>
                  <th className="px-4 lg:px-6 py-3 lg:py-4 text-center text-sm font-semibold text-base-content">Actions</th>
                </tr>
              </thead>
                ...
                {lessons.length > 0 ? lessons.map((lesson, index) => (
                  ...
                  >
                    <td className="px-4 lg:px-6 py-3 lg:py-4">
                      <div className="font-medium text-base-content text-sm lg:text-base">{lesson.title}</div>
                      <div className="text-xs lg:text-sm text-base-content/70">ID: {lesson._id?.slice(-8)}</div>
                    </td>

                    <td className="px-4 lg:px-6 py-3 lg:py-4 hidden md:table-cell">
                      <span className="inline-flex items-center px-2 lg:px-3 py-1 rounded-full text-xs font-medium bg-secondary/10 text-secondary border border-secondary/20">
                        {lesson.category}
                      </span>
                    </td>
                    ...
                    <td className="px-4 lg:px-6 py-3 lg:py-4">
                      <div className="flex flex-wrap gap-1 lg:gap-2 justify-center">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() => toggleFeatured(lesson._id, lesson.featured)}
                          className="px-2 lg:px-3 py-1 text-xs font-medium rounded-lg bg-info/10 text-info border border-info/20 hover:bg-info/20 transition-all duration-200"
                        >
                          {lesson.featured ? "Unfeature" : "Feature"}
                        </motion.button>
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() => markReviewed(lesson._id, lesson.reviewed)}
                          className="px-2 lg:px-3 py-1 text-xs font-medium rounded-lg bg-success/10 text-success border border-success/20 hover:bg-success/20 transition-all duration-200"
                        >
                          {lesson.reviewed ? "Unreview" : "Review"}
                        </motion.button>
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() => handleDelete(lesson._id)}
                          className="px-2 lg:px-3 py-1 text-xs font-medium rounded-lg bg-error/10 text-error border border-error/20 hover:bg-error/20 transition-all duration-200"
                        >
                          Delete
                        </motion.button>
                      </div>
...
const StatCard = ({ title, value, icon, color, delay }) => {
  ...
  return (
    <motion.div
      ...
      className={`bg-gradient-to-br ${getColorClasses()} rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center border shadow-lg hover:shadow-xl transition-all duration-300`}
    >
